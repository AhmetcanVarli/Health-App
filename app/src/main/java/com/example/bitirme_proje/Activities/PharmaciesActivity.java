...
import com.example.bitirme_proje.Utulities.FetchData;
...
import com.example.bitirme_proje.databinding.ActivityPharmaciesBinding;
import com.google.android.gms.tasks.OnSuccessListener;
import com.google.android.gms.tasks.Task;

public class PharmaciesActivity extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private ActivityPharmaciesBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPharmaciesBinding.inflate(getLayoutInflater());
        ...
        binding.atm.setOnClickListener(view -> {
            Log.d(TAG, "onCreate: atm ");
        ...
        binding.hospital.setOnClickListener(view -> {
            ...
            String url = stringBuilder.toString();
            Log.d(TAG, "onCreate: hospital " + url);
            Object dataFetch[] = new Object[2];
            dataFetch[0] = mMap;
            dataFetch[1] = url;
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null){
                    ...
                    mMap.addMarker(new MarkerOptions().position(latLng).title("Bulunduğunuz Konum"));
